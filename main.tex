...
have that LFCs and property criteria determines $h$ (and the \empt{thickness\_in\_meters}
...
Note that the sampled custom properties may be written to a \empth{csv}
